...
approximately 06:00 West African Time an outage occurred on isolated
Ubuntu 14.04 container running an Apache web server. GET requests on the server ld to
